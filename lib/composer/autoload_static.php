...
class ComposerStaticInitdc91119e814e712461766207c2826c8b
{
    ...
    public static $classMap = array (
        ...
        'Deposito' => __DIR__ . '/../..' . '/model/Deposito.class.php',
        'EasyPeasyICS' => __DIR__ . '/..' . '/phpmailer/phpmailer/extras/EasyPeasyICS.php',
        'EnviarEmail' => __DIR__ . '/../..' . '/model/EnviarEmail.class.php',
        'Historico' => __DIR__ . '/../..' . '/model/Historico.class.php',
        ...
        'Saque' => __DIR__ . '/../..' . '/model/Saque.class.php',
        'Sistema' => __DIR__ . '/../..' . '/model/Sistema.class.php',
        'Template' => __DIR__ . '/../..' . '/model/Template.class.php',
        'Transferencia' => __DIR__ . '/../..' . '/model/Transferencia.class.php',
        'User' => __DIR__ . '/../..' . '/model/User.class.php',
        'UserBasico' => __DIR__ . '/../..' . '/model/UserBasico.class.php',
        'UserInterface' => __DIR__ . '/../..' . '/model/User.interface.php',
        'UserPremium' => __DIR__ . '/../..' . '/model/UserPremium.class.php',
        'UserSalario' => __DIR__ . '/../..' . '/model/UserSalario.class.php',
